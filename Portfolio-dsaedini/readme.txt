...
About 14-18 hours total. Most of the time was learning new ways to do things


4. What online resources did you consult when completing this assignment? (list specific URLs)
In general w3schools.com used frequently
https://getbootstrap.com/docs/4.0/components/navbar/ 
https://toruskit.com/docs/utilities/background-image/
https://www.youtube.com/watch?v=VCVxtpjgO5Q&ab_channel=Keepcoding This helped a lot with seeting up the background
https://www.w3schools.com/icons/bootstrap_icons_glyphicons.asp
https://getbootstrap.com/docs/4.0/components/card/


5. What classmates or other individuals did you consult as part of this assignment? What did you discuss?
Did not consult with other classmates or individuals
